...
public class PasswordController {
  ...
  @PostMapping("/check")
  public String checkPassword(@RequestBody Map<String, String> body) {
    ...
    switch(key) {
      ...
      case "1111":
        if(password.length() < 12) {
          ...
          message = "Strong password! Consider making it even longer for maximum security.";
        } else {
          message = "Excellent password! Great job!";
        }
        break;
      default:
        message = "Start typing to check password strength";
